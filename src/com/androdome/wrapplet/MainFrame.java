...
public class MainFrame extends JFrame
{
	...
	public static void main(String[] args) throws IOException, SAXException {
		...
		frame.init();
		//frame.getApplet("LWJGL Applet", new URL[]{new URL("http://androdome.com/MPR/Applet/lwjgl_util_applet.jar"), new URL("http://androdome.com/MPR/Applet/lzma.jar")}, "org.lwjgl.util.applet.AppletLoader", params, "http://androdome.com/MPR/Applet/");
	}
	...
	public void navigate(URL url) throws SAXException, IOException
	{
		...
		browser.navigate(da.getRoot(),
                da,
                new java.awt.Dimension(scrollPane.getWidth(), scrollPane.getHeight()),
                url);
	...
	private void init() throws SAXException, IOException {
		...
		InputStream is = new ByteArrayInputStream("Welcome to Internet Adventure!".getBytes("UTF-8"));
		...
		browser = new BrowserCanvas(da.getRoot(),
                da,
                new java.awt.Dimension(scrollPane.getWidth(), scrollPane.getHeight()),
                null);
	...
	public void parseApplets(BrowserCanvas browser)
	{
		...
		Applet applet = getApplet(name,
				arUrl,
				box.getNode().getAttributes().getNamedItem("code").getNodeValue(),
				params,
				cb
				);
	...
	public MainFrame() {
		...
		btnNavigate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(null, "Connection failed:\n"+e1, "Connection failed", JOptionPane.ERROR_MESSAGE);
					e1.printStackTrace();
				}
	...
	public Applet getApplet(final String name, final URL[] archives, final String className, HashMap<String, String> params, final String codeBase)
	{
		...
		new Thread(){
			public void run(){
				URLClassLoader loader = new URLClassLoader(archives, this.getClass().getClassLoader());
			    ...
			    launcher.replace(createApplet(className, loader));
			}
			}.start();
